# app.py - COMPLETE PRODUCTION READY (WITH PROXY FIX)
...
# ─── =========================================================───
# ─── CRITICAL: Remove proxy environment variables BEFORE anything ───
...
def init_supabase():
    ...
    try:
        from services.supabase_client import get_supabase_client, test_connection
...
if __name__ == '__main__':
    ...
    # ─── Final proxy cleanup before starting ──────────────────
    for proxy_var in ['HTTP_PROXY', 'HTTPS_PROXY', 'http_proxy', 'https_proxy', 'ALL_PROXY', 'all_proxy']:
        if proxy_var in os.environ:
            del os.environ[proxy_var]
